...
<div class="card ">
    ...
    <div class="card-body">
        <table id="" class="table table-bordered table-hover">
            <button type="button" class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#CustomerTypeModal">
                Create
            </button>
            <thead>
                <tr>
            ...
            <tbody>
                @foreach ($customertypes as $item)
                    <tr>
                        ...
                        <td>
                            <form action="{{ route('customertype.destroy', $item->CustomerTypeId) }}" method="POST" class="d-inline">
                                @csrf
                                @method('DELETE')
        ...
        <div class="modal-body">
            <form method="POST" action="{{ route('customertype.store') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="CustomerTypeName" id="CustomerTypeName" class="form-control" required>
                </div>
