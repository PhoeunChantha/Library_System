        ...
        <div class="col-12">
            <div class="card card-primary">
                ...
                <div class="card-body">
                    ...
                    <div class="scroll-table" style="height: 10cm;">
                        <div class="row mt-4">
                            @foreach ($books as $book)
                                @php
                                ...
                                <div class="col-sm-3 mb-2">
                                    <div class="position-relative">
                                        <img width="100%"
                                            src="{{ $book->BookImage && file_exists(public_path('images/' . $book->BookImage)) ? asset('images/' . $book->BookImage) : asset('uploads/image/noimage.png') }}"
                                            alt="Book Image" class="img-fluid">
                                        <div class="ribbon-wrapper ribbon-xl">
                                            <div
                                                class="ribbon {{ $isReturned == 1 ? 'bg-primary' : 'bg-success' }} text-sm">
                                                {{ $book->catalog->CatalogName ?? 'Null' }}
                                            </div>
                                        </div>
                                    </div>
                                </div>
