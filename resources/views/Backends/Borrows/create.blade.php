        ...
        <div class="card">
            ...
            <div class="card-body">
                <form class="row" method="POST" action="{{ route('borrow.store') }}">
                    ...
                    <input type="hidden" name="BorrowId" id="BorrowId" value="{{ $borrow->BorrowId ?? old('BorrowId') }}">

                    <div class="form-group col-6">
                        <label for="customerId" class="form-label required">Customer Name</label>
                    ...
                    <div class="form-group col-6">
                        ...
                        <input type="text" name="UserId" id="UserId" class="form-control"
                            @if ($user) value="{{ $user->name }}" @endif disabled>
                    ...
                    <div class="form-group col-4">
                        <label for="BorrowDate" class="form-label required">Borrow Date</label>
                    ...
                    <div class="form-group col-4">
                        <label for="BorrowCode" class="form-label required">Borrow Code</label>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="select2" name="book_ids[]" multiple="multiple" data-placeholder="Select BookCode"
                            style="width: 100%;">
                            ...
                            @foreach ($books as $book)
                                @if (old('book_ids') == $book->BookId)
                                    <option value="{{ $book->BookId }}" selected>
                                        {{ $book->BookCode }} | ({{ $book->catalog->CatalogName ?? 'Null' }})</option>
                                @else
                                    <option value="{{ $book->BookId }}">
                                        {{ $book->BookCode }} | ({{ $book->catalog->CatalogName ?? 'Null' }})</option>
                                @endif
